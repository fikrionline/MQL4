...
extern double Step1 = 0.30;
extern double Step2 = 0.50;
extern double Step3 = 0.70;
extern double Step4 = 0.90;
extern double Step5 = 1.10;
...
void OnTick()
{
   ...
   string ShowComment = "GetDay " + IntegerToString(GetDay) + " :: BasicLot " + DoubleToStr(BasicLot, 2) + " :: SendNotif " + SendNotifComment + " :: Step " + DoubleToStr(Step1, 2) + " " + DoubleToStr(Step2, 2) + " "+ DoubleToStr(Step3, 2) + " "+ DoubleToStr(Step4, 2) + " "+ DoubleToStr(Step5, 2);
   ...
   double Lot2 = BasicLot * (PriceBid1 / PriceBid2);
   ...
   */
   ...
   if(SendNotif == true)
   {
      if(Prosentase1 > Step1 && Prosentase1 < Step2)
      {
      ...
      if(Prosentase1 > Step2 && Prosentase1 < Step3)
      {
         static datetime TimeStamp;
         int NotifCount = 0;
         if(TimeStamp != Time[0])
      ...
      if(Prosentase1 > Step3 && Prosentase1 < Step4)
      {
         static datetime TimeStamp;
         int NotifCount = 0;
         if(TimeStamp != Time[0])
      ...
      if(Prosentase1 > Step4 && Prosentase1 < Step5)
      {
         static datetime TimeStamp;
         int NotifCount = 0;
         if(TimeStamp != Time[0])
