...
void OnTick() {
   ...
   if (BasicLotRatio == PriceFromOther) {
      ...
      Lot1 = (BasicLot * (PriceBid2 / PriceBid3)) / 1000;
      Lot2 = (BasicLot * (PriceBid1 * PriceBid3)) / 1000;
      Lot3 = BasicLot * (PriceBid2 / PriceBid1);

   } else if (BasicLotRatio == Futures) {

      FuturesPair1 = (PriceBid1/1000) / ((PriceBid1/1000) * (PriceBid1/1000));
      FuturesPair2 = (PriceBid2/1000) / ((PriceBid2/1000) * (PriceBid2/1000));
