...
int init() {
   ...
   SetIndexStyle(0, EMPTY, STYLE_DOT, 0, czer);
   SetIndexLabel(0, "FollowLine(" + IntegerToString(BandsPeriod) + ")");
   SetIndexBuffer(1, histou);
   SetIndexStyle(1, DRAW_HISTOGRAM, EMPTY, EMPTY, chup);
   SetIndexLabel(1, NULL);
   SetIndexBuffer(2, histod);
   SetIndexStyle(2, DRAW_HISTOGRAM, EMPTY, EMPTY, chdn);
