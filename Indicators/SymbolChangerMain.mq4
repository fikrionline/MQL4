...
int OnInit()
{
    ...
    string IndicatorSymbol[8];
    IndicatorSymbol[0] = "AUDUSD";
    IndicatorSymbol[1] = "EURUSD";
    IndicatorSymbol[2] = "GBPUSD";
    IndicatorSymbol[3] = "NZDUSD";
    IndicatorSymbol[4] = "USDCAD";
    IndicatorSymbol[5] = "USDCHF";
    IndicatorSymbol[6] = "USDJPY";
    IndicatorSymbol[7] = "XAUUSD";

    string ButtonSymbolUniqueID[8];
    string ButtonSymbolString[8];
    string ButtonSymbolSymbolName[8];
