...
extern color Daily_Pivot = clrWhite;
extern color Daily_S_Levels = clrDarkOrange;
extern color Daily_R_Levels = clrGreen;
...
int start() {
    ...
    if (ObjectFind("PivotLabel") != 0) {
        ...
        ObjectSetText("PivotLabel", ("Fractals Pivot"), 8, "Arial", Daily_Pivot);
    } else {
    ...
    if (ObjectFind("R1_Label") != 0) {
        ...
        ObjectSetText("R1_Label", "Fractals R1", 8, "Arial", Daily_R_Levels);
    } else {
    ...
    if (ObjectFind("R2_Label") != 0) {
        ...
        ObjectSetText("R2_Label", "Fractals R2", 8, "Arial", Daily_R_Levels);
    } else {
    ...
    if (ObjectFind("R3_Label") != 0) {
        ...
        ObjectSetText("R3_Label", "Fractals R3", 8, "Arial", Daily_R_Levels);
    } else {
    ...
    if (ObjectFind("S1_Label") != 0) {
        ...
        ObjectSetText("S1_Label", "Fractals S1", 8, "Arial", Daily_S_Levels);
    } else {
    ...
    if (ObjectFind("S2_Label") != 0) {
        ...
        ObjectSetText("S2_Label", "Fractals S2", 8, "Arial", Daily_S_Levels);
    } else {
    ...
    if (ObjectFind("S3_Label") != 0) {
        ...
        ObjectSetText("S3_Label", "Fractals S3", 8, "Arial", Daily_S_Levels);
    } else {
    ...
    if (ObjectFind("RDeviasi_Label") != 0) {
        ...
        ObjectSetText("RDeviasi_Label", "Fractals RDeviasi", 8, "Arial", Daily_R_Levels);
    } else {
    ...
    if (ObjectFind("SDeviasi_Label") != 0) {
        ...
        ObjectSetText("SDeviasi_Label", "Fractals SDeviasi", 8, "Arial", Daily_S_Levels);
    } else {
