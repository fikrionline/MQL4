...
//------------------------------------------------------------------  
int theFractal(string M, int P, int shift) {
...
int start() {
   ...
   KG = Bars;
   while (KG >= 0) {
      if (theFractal("U", M15, KG) == 1) ExtMapBuffer1[KG] = High[KG];
      else ExtMapBuffer1[KG] = ExtMapBuffer1[KG + 1];
      if (theFractal("L", M15, KG) == 1) ExtMapBuffer2[KG] = Low[KG];
      else ExtMapBuffer2[KG] = ExtMapBuffer2[KG + 1];
      if (theFractal("U", H1, KG) == 1) ExtMapBuffer3[KG] = High[KG];
      else ExtMapBuffer3[KG] = ExtMapBuffer3[KG + 1];
      if (theFractal("L", H1, KG) == 1) ExtMapBuffer4[KG] = Low[KG];
      else ExtMapBuffer4[KG] = ExtMapBuffer4[KG + 1];
      if (theFractal("U", H4, KG) == 1) ExtMapBuffer5[KG] = High[KG];
      else ExtMapBuffer5[KG] = ExtMapBuffer5[KG + 1];
      if (theFractal("L", H4, KG) == 1) ExtMapBuffer6[KG] = Low[KG];
      else ExtMapBuffer6[KG] = ExtMapBuffer6[KG + 1];
      if (theFractal("U", D1, KG) == 1) ExtMapBuffer7[KG] = High[KG];
      else ExtMapBuffer7[KG] = ExtMapBuffer7[KG + 1];
      if (theFractal("L", D1, KG) == 1) ExtMapBuffer8[KG] = Low[KG];
