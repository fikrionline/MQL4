...
input bool     UseCustomSettings = true; // Use Custom Settings - if true = use below parameters:
input double   CustomMaxNoseBodySize = 0.33; // Max. Body / Candle length ratio of the Nose Bar
input double   CustomNoseBodyPosition = 0.3; // Body position in Nose Bar (e.g. top/bottom 40%)
input bool     CustomLeftEyeOppositeDirection = false; // true = Direction of Left Eye Bar should be opposite to pattern (bearish bar for bullish Pinbar pattern and vice versa)
