...
extern bool LimitBoxToMaxSize = false; // when true, a box larger than MaxBoxSizeInPips will be limited to MaxBoxSizeInPips, and centered on the EMA(box_time_range) value.
...
extern double TP5Factor = 2.000; // TP4 and TP5 targets are OPTIONAL: set TP5Factor=0 to allow only up to TP3 target;
...
//+------------------------------------------------------------------+
{
   ...
   if (TP3Factor < 10) TP3_pips = boxExtent * TP3Factor / pip;
      ...
      TP3_pips = TP3Factor;
      TP3Factor = TP3_pips * pip / boxExtent;
   }
   ...
   if (TP5Factor < 10) TP5_pips = boxExtent * TP5Factor / pip;
      ...
      TP5_pips = TP5Factor;
      TP5Factor = TP5_pips * pip / boxExtent;
   }
   ...
   if (TP4Factor < 10) TP4_pips = boxExtent * TP4Factor / pip;
      ...
      TP4_pips = TP4Factor;
      TP4Factor = TP4_pips * pip / boxExtent;
   }
