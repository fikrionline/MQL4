...
input double   inpLevel4         = 61.8;           // Level 4
input double   inpLevel5         = 100.0;          // Level 5
input double   inpLevel6         = 161.8;          // Level 6
input double   inpLevel7         = 261.8;          // Level 7
input double   inpLevel8         = 423.6;          // Level 8
...
// Set Levels Array
   ...
   levels[5] = inpLevel6;  levels[6] = inpLevel7;  levels[7] = inpLevel8;
