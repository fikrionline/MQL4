...
extern double BaseDeviasi = 1.00175623;
...
double Day_Price[][6];
double Pivot, S1, S2, S3, S4, S5, R1, R2, R3, R4, R5, RDeviasi, SDeviasi;
...
int start()
{
    ...
    R1 = YesterdayLow * BaseSNR;
    S1 = YesterdayHigh / BaseSNR;
    
    RDeviasi = YesterdayLow * BaseDeviasi;
    SDeviasi = YesterdayHigh / BaseDeviasi;
    ...
    if (Daily == true)
    {
        ...
        if (Daily_SR_Levels == true)
        {
            ...
            if (ObjectFind("R4_Label") != 0)
            {
                ...
                ObjectSetText("R4_Label", "Daily R4", 8, "Arial", Daily_R_Levels);
            }
            else
            {
            ...
            if (ObjectFind("R5_Label") != 0)
            {
                ...
                ObjectSetText("R5_Label", "Daily R5", 8, "Arial", Daily_R_Levels);
            }
            else
            {
            ...
            if (ObjectFind("S4_Label") != 0)
            {
                ...
                ObjectSetText("S4_Label", "Daily S4", 8, "Arial", Daily_S_Levels);
            }
            else
            {
            ...
            if (ObjectFind("S5_Label") != 0)
            {
                ...
                ObjectSetText("S5_Label", "Daily S5", 8, "Arial", Daily_S_Levels);
            }
            else
            {
