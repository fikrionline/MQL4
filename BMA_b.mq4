...
int Signal()
{
   ...
   if((iMA_4_0 > iMA_16) && (iMA_16 > iMA_96) && (iMA_4_0 >= iMA_4_1))
   {
      iMA_checker = 1;
   }
   ...
   if((iStdDev_16_0 - iStdDev_16_3) >= 0.0002 && (iStdDev_16_0 - iStdDev_16_1) >= 0.0001)
   {
      iStdDev_checker = 1;
   }
   ...
   else
   {
      for (int i=OrdersTotal()-1; i>=0; i--)
      {
         ...
         {            
            ...
            {
               if((iStdDev_16_0 - iStdDev_16_1) <= 0.0001)
               {
                  if (OrderType() == OP_BUY)
                  {
