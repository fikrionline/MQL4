...
int OnInit()
{
    ...
    string IndicatorSymbol[10];
      IndicatorSymbol[0] = "AUDUSD";
      IndicatorSymbol[1] = "EURJPY";
      IndicatorSymbol[2] = "EURUSD";
      IndicatorSymbol[3] = "GBPJPY";
      IndicatorSymbol[4] = "GBPUSD";
      IndicatorSymbol[5] = "NZDUSD";
      IndicatorSymbol[6] = "USDCAD";
      IndicatorSymbol[7] = "USDCHF";
      IndicatorSymbol[8] = "USDJPY";
      IndicatorSymbol[9] = "XAUUSD";

    string ButtonSymbolUniqueID[10];
    string ButtonSymbolString[10];
    string ButtonSymbolSymbolName[10];
