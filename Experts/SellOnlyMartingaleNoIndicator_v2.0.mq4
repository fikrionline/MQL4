...
double PriceTargetSell, AveragePriceSell, LastSellPrice, iLotsSell, Multiplier, ADRs, PipStep, PipStepDevideResult, TakeProfit, TakeProfitDevideResult, Count, LastPipStepMultiplierSell;
...
void Info() {
   ...
   Comment("",
      ...
      "\nPipStep = ", LastPipStepMultiplierSell,
