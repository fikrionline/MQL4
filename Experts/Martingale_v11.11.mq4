...
#property description "Martingale EA basic on Indicator"
...
extern double EquityStopEA = 5000.00;
...
extern string EAName = "v11.11";

int TicketOrder, expiration, total, ticket, timeprev = 0, NumOfTrades = 0, cnt = 0;
double PriceTarget, BuyTarget, SellTarget, AveragePrice, SellLimit, BuyLimit, LastBuyPrice, LastSellPrice, Spread, iLots, Multiplier, PrevEquity, ADRs, PipStep, PipStepDevideResult, TakeProfit, TakeProfitDevideResult;
...
void Info() {
   ...
   Comment("",
      "Martigale EA basic on Indicator",
