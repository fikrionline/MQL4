...
input double EquityMaxStopEA = 10000;
input int MagicNumber = 575899;
input string TimeToOpen = "10:10:10";
input double Lots = 0.3;
input int StopLoss = 300;
input int TakeProfit = 900;
...
int GetSignal() {
   ...
   int SignalResult = 0;
   int SignalRandom = MathRand();
   
   SignalRandom = SignalRandom % 2;
   if(SignalRandom == 1) {
      SignalResult = 1;
   } else if(SignalRandom == 0) {
      SignalResult = -1;
   }
