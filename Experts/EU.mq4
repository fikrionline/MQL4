...
int start() {
   ...
   ObjectSetText("j", "EU", 11, "Times New Roman Bold", 65280); */
   S_s_20 = "" + AccountCompany();
   S_s_20 = S_s_20 + "\n";
   S_s_20 = S_s_20 + "===================";
   S_s_20 = S_s_20 + "\n";
   ...
   if (Use_Daily_Target) {
      ...
      if (G_i_2 >= 0) {
         do {
            if (OrderSelect(G_i_2, 0, 1) && OrderMagicNumber() == TheMagicNumber) {
   ...
   if (Hidden_TP) {
      ...
      if (OrdersTotal() > 0) {
         do {
            if (!OrderSelect(G_i_4, 0, 0) || (OrderSymbol() == _Symbol && OrderMagicNumber() == TheMagicNumber)) {
   ...
   if (G_i_8 > 0) {
      do {
         ...
         if (OrderMagicNumber() == TheMagicNumber && OrderSymbol() == S_s_21 && G_i_7 == OrderType()) {
            G_i_75 = G_i_9 + 1;
            G_i_9 = G_i_75;
         }
         G_i_10 = G_i_10 + 1;
   ...
   if (G_i_12 > 0) {
      do {
         ...
         if (OrderMagicNumber() == TheMagicNumber && OrderSymbol() == S_s_22 && G_i_11 == OrderType()) {
            G_i_75 = G_i_13 + 1;
            G_i_13 = G_i_75;
         }
         G_i_14 = G_i_14 + 1;
