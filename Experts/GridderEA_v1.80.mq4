...
extern ProgrO StepOrdersProgress  = Statical_Step;//Type Of Progress Step
...
extern double RiskFactor          = 0.01;//Risk Factor For Auto Lot
extern double ManualLotSize       = 0.01;//Manual Lot Size
extern ProgrL LotOrdersProgress   = Exponential_Lot;//Type Of Progress Lot
...
int OnInit() {
   ...
   if (RiskFactor > 0.5) RiskFactor = 0.5;
...
void CommentChart() {
   ...
   Comment(
      ...
      "\n  Emergency Mode: " + EmergencyStr + ShowInfoOfPairs +
      "\n  Orders: " + DoubleToStr(TotalOrders, 0) + " (" + DoubleToStr(MaxTotalOrders, 0) + ")" +
      "\n  PnL: " + DoubleToStr(TotalProfitLoss, 2) + " (" + DoubleToStr(ShowMinProfit, 2) + ")" +
      "\n  Lots: " + DoubleToStr(TotalLots, 2) +
