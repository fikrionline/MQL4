...
double MinLot, MaxLot, LotStep, StopLevel, TickValue, Spread;
int DigitLot, DigitFactor;

// Display
string lbl = "GridEA";
int XValue = 20, YValue = 20, XSize = 80, YSize = 20;
...
int MagicNumber = 5758;

double BuyPrice, SellPrice;
int SumBuy, SumSell;
double NextBuy, NextSell, NextBuyLot, NextSellLot;
//+------------------------------------------------------------------+
