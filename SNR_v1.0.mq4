...
int deinit() {
   ...
   ObjectDelete("PivotLineVertical");
...
int start() {
   ...
   datetime PivotTime = iTime(Symbol(), PERIOD_D1, BaseHHLL);

   ObjectCreate("PivotLineVertical", OBJ_VLINE, 0, PivotTime, 0);
   ObjectSet("PivotLineVertical", OBJPROP_COLOR, Daily_Pivot);
   ObjectSet("PivotLineVertical", OBJPROP_STYLE, STYLE_DASHDOT);
