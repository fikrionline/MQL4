...
extern string OrderCmt = "XMT-Scalper 2.4.3";// Trade comments that appears in the Trade and Account History tab
...
extern double TakeProfit = 40;				// TakeProfit from as many points. Default 100 (= 10 pip)
...
string ea_version = "XMT-Scalper v. 2.4.3";
...
int init() 
{
   ...
   ArrayInitialize(array_spread, 0);
	...
	// Calculate lot multiplicator for Account Currency. Assumes that account currency is either USD, EUR, GBP, CHF or JPY
