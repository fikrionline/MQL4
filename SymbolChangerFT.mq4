...
int OnInit()
{
    ...
    IndicatorSymbol[0] = "AUDCAD.ft";
   IndicatorSymbol[1] = "AUDCHF.ft";
   IndicatorSymbol[2] = "AUDJPY.ft";
   IndicatorSymbol[3] = "AUDNZD.ft";
   IndicatorSymbol[4] = "AUDUSD.ft";
   IndicatorSymbol[5] = "CADCHF.ft";
   IndicatorSymbol[6] = "CADJPY.ft";
   IndicatorSymbol[7] = "CHFJPY.ft";
   IndicatorSymbol[8] = "EURAUD.ft";
   IndicatorSymbol[9] = "EURCAD.ft";
   IndicatorSymbol[10] = "EURCHF.ft";
   IndicatorSymbol[11] = "EURGBP.ft";
   IndicatorSymbol[12] = "EURJPY.ft";
   IndicatorSymbol[13] = "EURNZD.ft";
   IndicatorSymbol[14] = "EURUSD.ft";
   IndicatorSymbol[15] = "GBPAUD.ft";
   IndicatorSymbol[16] = "GBPCAD.ft";
   IndicatorSymbol[17] = "GBPCHF.ft";
   IndicatorSymbol[18] = "GBPJPY.ft";
   IndicatorSymbol[19] = "GBPNZD.ft";
   IndicatorSymbol[20] = "GBPUSD.ft";
   IndicatorSymbol[21] = "NZDCAD.ft";
   IndicatorSymbol[22] = "NZDCHF.ft";
   IndicatorSymbol[23] = "NZDJPY.ft";
   IndicatorSymbol[24] = "NZDUSD.ft";
   IndicatorSymbol[25] = "USDCAD.ft";
   IndicatorSymbol[26] = "USDCHF.ft";
   IndicatorSymbol[27] = "USDJPY.ft";
   IndicatorSymbol[28] = "XAUUSD.ft";
