...
input double StartPrice = 1.14098;
...
int start() {
   ...
   for (int i=1; i<=LevelSize; i++) {
      ...
      ObjectSetText("+" + IntegerToString(i) + "Label", DoubleToString(LastLevelPlus, 5), 8, "Arial", Aqua);
      ObjectSet("+" + IntegerToString(i) + "Label", OBJPROP_BACK, true);
      
      LastLevelPlusDeviasiUpper = LastLevelPlus * ResultDeviasiBase;
      
      ObjectCreate("+d+" + IntegerToString(i), OBJ_HLINE, 0, CurTime(), NormalizeDouble(LastLevelPlusDeviasiUpper, 5));
      ...
      ObjectCreate("+d-" + IntegerToString(i), OBJ_HLINE, 0, CurTime(), NormalizeDouble(LastLevelPlusDeviasiLower, 5));
      ObjectSet("+d-" + IntegerToString(i), OBJPROP_COLOR, StringToColor("66, 66, 66"));
      ObjectSet("+d-" + IntegerToString(i), OBJPROP_STYLE, STYLE_DASHDOT);
      ObjectSet("+d-" + IntegerToString(i), OBJPROP_BACK, true);
      ...
      ObjectSetText("-" + IntegerToString(i) + "Label", DoubleToString(LastLevelMinus, 5), 8, "Arial", Aqua);
      ObjectSet("-" + IntegerToString(i) + "Label", OBJPROP_BACK, true);
