...
extern bool    ECN_Mode = TRUE; // ECN_Mode: True for brokers that don't accept SL and TP to be sent at the same time as the order
...
extern ENUM_TIMEFRAMES TimeFrame = PERIOD_M1; // TimeFrame: Trading timeframe must match the timeframe of the chart
...
extern int     Indicatorperiod = 2; // Indicatorperiod: Period in bars for indicator
extern double  BBDeviation = 1.0; // BBDeviation: Deviation for the iBands indicator only
