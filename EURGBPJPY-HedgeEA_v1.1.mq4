...
void OnTick() {
   ...
   Comments2 = Pair2 + " " + DoubleToStr(BasicOpen2, 3) + " --> " + DoubleToStr(PriceBid2, 3) + " = " + PlusMinus2 + DoubleToStr(Change2Prosentase, 3) + "% Lot " + DoubleToStr(Lot2, 2);
   ...
   Comments3 = Pair3 + " " + DoubleToStr(BasicOpen3, 3) + " --> " + DoubleToStr(PriceBid3, 3) + " = " + PlusMinus3 + DoubleToStr(Change3Prosentase, 3) + "% Lot " + DoubleToStr(Lot3, 2);
