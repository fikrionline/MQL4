...
extern string Minimal_Deposit = "Test for FTMO Trial 50K";
extern string Time_Frame = "M1";
extern string Pairs = "EURUSD";
extern bool Use_Daily_Target = false;
extern double Daily_Target = 250;
extern bool Hidden_TP = false;
extern double Hiden_TP = 500;
extern double Lot = 0.05;
extern double LotMultiplikator = 2;
extern double TakeProfit = 60;
extern double Step = 60;
extern double Averaging = 0;
extern int MaxTrades = 33;
extern bool UseEquityStop = false;
extern double TotalEquityRisk = 10000;
extern bool FloatingMinusStop = false;
extern double MaxFloatingMinus = 1000;
extern int Open_Hour = 1;
extern int Close_Hour = 23;
extern bool TradeOnThursday = true;
extern int Thursday_Hour = 23;
extern bool TradeOnFriday = true;
extern int Friday_Hour = 23;
extern bool Filter_Sideway = true;
extern bool Filter_News = true;
extern bool invisible_mode = true;
extern double OpenRangePips = 1;
extern double MaxDailyRange = 1000;
...
int init() {
   ...
   I_d_49 = 10;
   I_d_47 = 0;
   I_s_6 = "Number of trades 29 max 27 2x";
   I_s_7 = "Stop Loss";
   I_b_23 = false;
   I_b_12 = false;
   I_b_13 = false;
...
int start() {
   ...
   if(FloatingMinusStop == true) {
      double floating_minus = MathAbs(AccountBalance() - (AccountEquity() + OrderCommission() + OrderSwap()));
      if(floating_minus >= MaxFloatingMinus) {
         CloseAllOrders();
      }
   }
   ...
   ObjectSetText("j", "BISMILLAHIRROHMANIRROHIM", 17, "Arial", 65280);
   MainInfo = "\n";
   MainInfo = MainInfo + "=================";
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "ACC INFORMATION";
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Broker Name : " + AccountCompany();
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Account Number : ";
   S_s_21 = (string) AccountNumber();
   MainInfo = MainInfo + S_s_21;
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Account Leverage : ";
   MainInfo = MainInfo + DoubleToString(AccountLeverage(), 0);
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Currency : ";
   MainInfo = MainInfo + AccountCurrency();
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  EQUITY : ";
   MainInfo = MainInfo + DoubleToString(AccountEquity(), 2);
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  BALANCE : ";
   MainInfo = MainInfo + DoubleToString(AccountBalance(), 2);
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  FLOATING : ";
   MainInfo = MainInfo + DoubleToString((AccountEquity() - AccountBalance()), 2);
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "=================";
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "MARGIN INFORMATION";
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Free Margin : ";
   MainInfo = MainInfo + DoubleToString(AccountFreeMargin(), 2);
   MainInfo = MainInfo + "\n";
   MainInfo = MainInfo + "  Used Margin : ";
   MainInfo = MainInfo + DoubleToString(AccountMargin(), 2);
